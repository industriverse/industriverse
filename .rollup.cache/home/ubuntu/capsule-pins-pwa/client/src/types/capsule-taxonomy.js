...
export var CAPSULE_CATEGORY_METADATA = (_a = {},
    // Semiconductor Manufacturing
    _a[CAPSULE_CATEGORIES.THERMAL_MANAGEMENT] = {
    ...
    _a[CAPSULE_CATEGORIES.PLASMA_DYNAMICS] = {
    ...
    _a[CAPSULE_CATEGORIES.RESIST_DIFFUSION] = {
    ...
    _a[CAPSULE_CATEGORIES.YIELD_OPTIMIZATION] = {
    ...
    _a[CAPSULE_CATEGORIES.DEFECT_DETECTION] = {
    ...
    _a[CAPSULE_CATEGORIES.PROCESS_CONTROL] = {
    ...
    _a[CAPSULE_CATEGORIES.ENERGY_OPTIMIZATION] = {
    ...
    _a[CAPSULE_CATEGORIES.CARBON_TRACKING] = {
    ...
    _a[CAPSULE_CATEGORIES.RENEWABLE_INTEGRATION] = {
    ...
    _a[CAPSULE_CATEGORIES.GRID_BALANCING] = {
    ...
    _a[CAPSULE_CATEGORIES.ENERGY_STORAGE] = {
    ...
    // Edge Computing & IoT
    _a[CAPSULE_CATEGORIES.EDGE_ADAPTATION] = {
    ...
    _a[CAPSULE_CATEGORIES.SENSOR_FUSION] = {
    ...
    _a[CAPSULE_CATEGORIES.PREDICTIVE_MAINTENANCE] = {
    ...
    _a[CAPSULE_CATEGORIES.ANOMALY_DETECTION] = {
    ...
    _a[CAPSULE_CATEGORIES.INVENTORY_OPTIMIZATION] = {
    ...
    _a[CAPSULE_CATEGORIES.DEMAND_FORECASTING] = {
    ...
    _a[CAPSULE_CATEGORIES.ROUTE_OPTIMIZATION] = {
    ...
    // Quality & Compliance
    _a[CAPSULE_CATEGORIES.QUALITY_ASSURANCE] = {
    ...
    _a[CAPSULE_CATEGORIES.REGULATORY_COMPLIANCE] = {
    ...
    _a[CAPSULE_CATEGORIES.AUDIT_TRAIL] = {
    ...
    _a[CAPSULE_CATEGORIES.COST_OPTIMIZATION] = {
    ...
    _a[CAPSULE_CATEGORIES.REVENUE_FORECASTING] = {
    ...
    _a[CAPSULE_CATEGORIES.RISK_MANAGEMENT] = {
    ...
    // Human Capital
    _a[CAPSULE_CATEGORIES.WORKFORCE_SCHEDULING] = {
    ...
    _a[CAPSULE_CATEGORIES.SKILLS_MATCHING] = {
    ...
    _a[CAPSULE_CATEGORIES.SAFETY_MONITORING] = {
 ...
 */
export function getCategoriesByServiceFamily(serviceFamily) {
    return getAllCategories().filter(function (cat) { return cat.serviceFamily === serviceFamily; });
}
/**
 * Get category by ID
 */
...
export function searchCategories(query) {
    ...
    return getAllCategories().filter(function (cat) {
        return cat.name.toLowerCase().includes(lowerQuery) ||
            ...
            cat.examples.some(function (ex) { return ex.toLowerCase().includes(lowerQuery); });
    });
}
//# sourceMappingURL=capsule-taxonomy.js.map