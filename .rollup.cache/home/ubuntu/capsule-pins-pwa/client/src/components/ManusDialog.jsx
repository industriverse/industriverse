...
export function ManusDialog(_a) {
    var _b = _a.title, title = _b === void 0 ? APP_TITLE : _b, _c = _a.logo, logo = _c === void 0 ? APP_LOGO : _c, _d = _a.open, open = _d === void 0 ? false : _d, onLogin = _a.onLogin, onOpenChange = _a.onOpenChange, onClose = _a.onClose;
    var _e = useState(open), internalOpen = _e[0], setInternalOpen = _e[1];
    useEffect(function () {
        if (!onOpenChange) {
...
//# sourceMappingURL=ManusDialog.jsx.map